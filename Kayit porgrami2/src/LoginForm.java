...
//       }
      if(String.valueOf(password.getPassword()).equals("")||username.getText().equals("")){
//         lbl_p.setVisible(true);
          ...
          ResultSet rs;
               ...
               if(rs.next())
               {
                  MainFormO mf=new MainFormO();
                  mf.setVisible(true);
                  mf.pack();
                  mf.setLocationRelativeTo(null);
                  mf.setExtendedState(JFrame.MAXIMIZED_BOTH);
        MainFormO.jLabel_Username.setText("Hosgeldiniz Ogretmen <"+username.getText()+">");
                 MainFormO.jLabel_StdCount.setText("Ogrenci sayisi= "+Integer.toString(MyFunction.countData(" student")));
//                MainForm.jLabel_ders.setText("Course Count = "+Integer.toString(MyFunction.countData("kurs")));
                 this.dispose();
                }
               else{
